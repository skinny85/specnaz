...
public final class TestsTreeCoreDslBuilder implements CoreDslBuilder {
    ...
    @Override
    public <T extends Throwable, P1, P2, P3, P4, P5, P6, P7> ParamsExpectedException7<T, P1, P2, P3, P4, P5, P6, P7> parametrizedTestExpectingException7(
    ...
    @Override
    public <T extends Throwable, P1, P2, P3, P4, P5, P6, P7> ParamsExpectedException7<T, P1, P2, P3, P4, P5, P6, P7> focusedParametrizedTestExpectingException7(
            Class<T> expectedException, String description, TestClosureParams7<P1, P2, P3, P4, P5, P6, P7> testBody) {
        return testsGroupNodeAccumulator.addParametrizedExceptionTest7(expectedException,
                description, testBody, TestCaseType.FOCUSED);
    }
    ...
    @Override
    public <T extends Throwable, P1, P2, P3, P4, P5, P6, P7> ParamsExpectedException7<T, P1, P2, P3, P4, P5, P6, P7> ignoredParametrizedTestExpectingException7(
            Class<T> expectedException, String description, TestClosureParams7<P1, P2, P3, P4, P5, P6, P7> testBody) {
        return testsGroupNodeAccumulator.addParametrizedExceptionTest7(expectedException,
                description, testBody, TestCaseType.IGNORED);
    }
    ...
    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8> ParamsExpected8<P1, P2, P3, P4, P5, P6, P7, P8> parametrizedTest8(
            String description, TestClosureParams8<P1, P2, P3, P4, P5, P6, P7, P8> testBody) {
        return testsGroupNodeAccumulator.addParametrizedPositiveTest8(description, testBody, TestCaseType.REGULAR);
    }

    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8> ParamsExpected8<P1, P2, P3, P4, P5, P6, P7, P8> focusedParametrizedTest8(
            String description, TestClosureParams8<P1, P2, P3, P4, P5, P6, P7, P8> testBody) {
        return testsGroupNodeAccumulator.addParametrizedPositiveTest8(description, testBody, TestCaseType.FOCUSED);
    }

    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8> ParamsExpected8<P1, P2, P3, P4, P5, P6, P7, P8> ignoredParametrizedTest8(
            String description, TestClosureParams8<P1, P2, P3, P4, P5, P6, P7, P8> testBody) {
        return testsGroupNodeAccumulator.addParametrizedPositiveTest8(description, testBody, TestCaseType.IGNORED);
    }
    ...
    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpected9<P1, P2, P3, P4, P5, P6, P7, P8, P9> parametrizedTest9(
    ...
    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpected9<P1, P2, P3, P4, P5, P6, P7, P8, P9> focusedParametrizedTest9(
            String description, TestClosureParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> testBody) {
        return testsGroupNodeAccumulator.addParametrizedPositiveTest9(description, testBody, TestCaseType.FOCUSED);
    }

    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpected9<P1, P2, P3, P4, P5, P6, P7, P8, P9> ignoredParametrizedTest9(
            String description, TestClosureParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> testBody) {
        return testsGroupNodeAccumulator.addParametrizedPositiveTest9(description, testBody, TestCaseType.IGNORED);
    }

    @Override
    public <T extends Throwable, P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpectedException9<T, P1, P2, P3, P4, P5, P6, P7, P8, P9> parametrizedTestExpectingException9(
    ...
    @Override
    public <P1, P2, P3, P4, P5, P6, P7> ParamsExpectedSubgroup7<P1, P2, P3, P4, P5, P6, P7> parametrizedSubSpecification7(
        ...
        return new ParamsExpectedSubgroup7<>(addParametrizedSubgroup(
                new ParametrizedSubgroup7<>(description, specClosure, TestCaseType.REGULAR)));
    }

    @Override
    public <P1, P2, P3, P4, P5, P6, P7> ParamsExpectedSubgroup7<P1, P2, P3, P4, P5, P6, P7> focusedParametrizedSubSpecification7(
            String description, RunnableParams7<P1, P2, P3, P4, P5, P6, P7> specClosure) {
        return new ParamsExpectedSubgroup7<>(addParametrizedSubgroup(
                new ParametrizedSubgroup7<>(description, specClosure, TestCaseType.FOCUSED)));
    }

    @Override
    public <P1, P2, P3, P4, P5, P6, P7> ParamsExpectedSubgroup7<P1, P2, P3, P4, P5, P6, P7> ignoredParametrizedSubSpecification7(
            String description, RunnableParams7<P1, P2, P3, P4, P5, P6, P7> specClosure) {
        return new ParamsExpectedSubgroup7<>(addParametrizedSubgroup(
    ...
    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpectedSubgroup9<P1, P2, P3, P4, P5, P6, P7, P8, P9> parametrizedSubSpecification9(
    ...
    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpectedSubgroup9<P1, P2, P3, P4, P5, P6, P7, P8, P9> focusedParametrizedSubSpecification9(
            String description, RunnableParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> specClosure) {
        return new ParamsExpectedSubgroup9<>(addParametrizedSubgroup(
                new ParametrizedSubgroup9<>(description, specClosure, TestCaseType.FOCUSED)));
    }

    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpectedSubgroup9<P1, P2, P3, P4, P5, P6, P7, P8, P9> ignoredParametrizedSubSpecification9(
            String description, RunnableParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> specClosure) {
        return new ParamsExpectedSubgroup9<>(addParametrizedSubgroup(
                new ParametrizedSubgroup9<>(description, specClosure, TestCaseType.IGNORED)));
    }
