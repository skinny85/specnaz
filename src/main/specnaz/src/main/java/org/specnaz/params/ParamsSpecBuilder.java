...
public interface ParamsSpecBuilder extends SpecBuilder {
    ...
    /**
     * The parametrized version of {@link SpecBuilder#shouldThrow} that takes 7 parameters.
     *
     * @param expectedException
     *     the type of Exception expected by the test
     * @param description
     ...
     *
     * @see SpecBuilder#shouldThrow
     * @see #fshouldThrow(Class, String, TestClosureParams7)
     * @see #xshouldThrow(Class, String, TestClosureParams7)
     */
    <T extends Throwable, P1, P2, P3, P4, P5, P6, P7> ParamsExpectedException7<T, P1, P2, P3, P4, P5, P6, P7> shouldThrow(
            Class<T> expectedException, String description, TestClosureParams7<P1, P2, P3, P4, P5, P6, P7> testBody);

    /**
     * The parametrized version of {@link SpecBuilder#fshouldThrow} that takes 7 parameters.
     *
     * @param expectedException
     *     the type of Exception expected by the test
     * @param description
     ...
     *
     * @see SpecBuilder#fshouldThrow
     * @see #shouldThrow(Class, String, TestClosureParams7)
     * @see #xshouldThrow(Class, String, TestClosureParams7)
     * @deprecated for the same reasons {@link SpecBuilder#fshould} is
     */
    @Deprecated
    <T extends Throwable, P1, P2, P3, P4, P5, P6, P7> ParamsExpectedException7<T, P1, P2, P3, P4, P5, P6, P7> fshouldThrow(
            Class<T> expectedException, String description, TestClosureParams7<P1, P2, P3, P4, P5, P6, P7> testBody);

    /**
     * The parametrized version of {@link SpecBuilder#xshouldThrow} that takes 7 parameters.
     *
     * @param expectedException
     *     the type of Exception expected by the test
     * @param description
     ...
     * @see #fshouldThrow(Class, String, TestClosureParams7)
     */
    <T extends Throwable, P1, P2, P3, P4, P5, P6, P7> ParamsExpectedException7<T, P1, P2, P3, P4, P5, P6, P7> xshouldThrow(
            Class<T> expectedException, String description, TestClosureParams7<P1, P2, P3, P4, P5, P6, P7> testBody);

    /**
     * The parametrized version of {@link SpecBuilder#should} that takes 8 parameters.
     *
     * @param description
     *     the description of the test
     * @param testBody
     ...
     */
    <P1, P2, P3, P4, P5, P6, P7, P8> ParamsExpected8<P1, P2, P3, P4, P5, P6, P7, P8> should(String description,
    ...
    /**
     * The parametrized version of {@link SpecBuilder#fshouldThrow} that takes 8 parameters.
     *
     * @param expectedException
     *     the type of Exception expected by the test
     * @param description
     ...
     *
     * @see SpecBuilder#fshouldThrow
     * @see #shouldThrow(Class, String, TestClosureParams8)
     * @see #xshouldThrow(Class, String, TestClosureParams8)
     * @deprecated for the same reasons {@link SpecBuilder#fshould} is
     */
    @Deprecated
    <T extends Throwable, P1, P2, P3, P4, P5, P6, P7, P8> ParamsExpectedException8<T, P1, P2, P3, P4, P5, P6, P7, P8> fshouldThrow(
            Class<T> expectedException, String description, TestClosureParams8<P1, P2, P3, P4, P5, P6, P7, P8> testBody);

    /**
     * The parametrized version of {@link SpecBuilder#xshouldThrow} that takes 8 parameters.
     *
     * @param expectedException
     *     the type of Exception expected by the test
     * @param description
     ...
     * @see #fshouldThrow(Class, String, TestClosureParams8)
     */
    <T extends Throwable, P1, P2, P3, P4, P5, P6, P7, P8> ParamsExpectedException8<T, P1, P2, P3, P4, P5, P6, P7, P8> xshouldThrow(
            Class<T> expectedException, String description, TestClosureParams8<P1, P2, P3, P4, P5, P6, P7, P8> testBody);

    /**
     * The parametrized version of {@link SpecBuilder#should} that takes 9 parameters.
     *
     * @param description
     *     the description of the test
     * @param testBody
     ...
     *
     * @see SpecBuilder#should
     * @see #fshould(String, TestClosureParams9)
     * @see #xshould(String, TestClosureParams9)
     */
    <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpected9<P1, P2, P3, P4, P5, P6, P7, P8, P9> should(String description,
            TestClosureParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> testBody);

    /**
     * The parametrized version of {@link SpecBuilder#fshould} that takes 9 parameters.
     *
     * @param description
     *     the description of the test
     * @param testBody
     ...
     *
     * @see SpecBuilder#fshould
     * @see #should(String, TestClosureParams9)
     * @see #xshould(String, TestClosureParams9)
     * @deprecated for the same reasons {@link SpecBuilder#fshould} is
     */
    @Deprecated
    <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpected9<P1, P2, P3, P4, P5, P6, P7, P8, P9> fshould(String description,
            TestClosureParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> testBody);

    /**
     * The parametrized version of {@link SpecBuilder#xshould} that takes 9 parameters.
     *
     * @param description
     *     the description of the test
     * @param testBody
     ...
     * @see #fshould(String, TestClosureParams9)
     */
    <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpected9<P1, P2, P3, P4, P5, P6, P7, P8, P9> xshould(String description,
            TestClosureParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> testBody);

    /**
     * The parametrized version of {@link SpecBuilder#shouldThrow} that takes 9 parameters.
     *
     * @param expectedException
     *     the type of Exception expected by the test
     * @param description
     ...
     */
    <T extends Throwable, P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpectedException9<T, P1, P2, P3, P4, P5, P6, P7, P8, P9> shouldThrow(
    ...
    /**
     * The parametrized version of {@link SpecBuilder#describes} that takes 7 parameters.
     *
     * @param description
     *    the description of the new test group
     * @param specClosure
     ...
     *
     * @see SpecBuilder#describes
     * @see #fdescribes(String, RunnableParams7)
     * @see #xdescribes(String, RunnableParams7)
     */
    <P1, P2, P3, P4, P5, P6, P7> ParamsExpectedSubgroup7<P1, P2, P3, P4, P5, P6, P7> describes(String description,
            RunnableParams7<P1, P2, P3, P4, P5, P6, P7> specClosure);

    /**
     * The parametrized version of {@link SpecBuilder#fdescribes} that takes 7 parameters.
     *
     * @param description
     *    the description of the new test group
     * @param specClosure
     ...
     *
     * @see SpecBuilder#fdescribes
     * @see #describes(String, RunnableParams7)
     * @see #xdescribes(String, RunnableParams7)
     * @deprecated for the same reasons {@link SpecBuilder#fshould} is
     */
    @Deprecated
    <P1, P2, P3, P4, P5, P6, P7> ParamsExpectedSubgroup7<P1, P2, P3, P4, P5, P6, P7> fdescribes(String description,
            RunnableParams7<P1, P2, P3, P4, P5, P6, P7> specClosure);

    /**
     * The parametrized version of {@link SpecBuilder#xdescribes} that takes 7 parameters.
     *
     * @param description
     *    the description of the new test group
     * @param specClosure
    ...
    /**
     * The parametrized version of {@link SpecBuilder#describes} that takes 9 parameters.
     *
     * @param description
     *    the description of the new test group
     * @param specClosure
     ...
     *
     * @see SpecBuilder#describes
     * @see #fdescribes(String, RunnableParams9)
     * @see #xdescribes(String, RunnableParams9)
     */
    <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpectedSubgroup9<P1, P2, P3, P4, P5, P6, P7, P8, P9> describes(String description,
            RunnableParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> specClosure);

    /**
     * The parametrized version of {@link SpecBuilder#fdescribes} that takes 9 parameters.
     *
     * @param description
     *    the description of the new test group
     * @param specClosure
     ...
     *
     * @see SpecBuilder#fdescribes
     * @see #describes(String, RunnableParams9)
     * @see #xdescribes(String, RunnableParams9)
     * @deprecated for the same reasons {@link SpecBuilder#fshould} is
     */
    @Deprecated
    <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpectedSubgroup9<P1, P2, P3, P4, P5, P6, P7, P8, P9> fdescribes(String description,
            RunnableParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> specClosure);

    /**
     * The parametrized version of {@link SpecBuilder#xdescribes} that takes 9 parameters.
     *
     * @param description
     *    the description of the new test group
     * @param specClosure
     ...
     * @see #fdescribes(String, RunnableParams9)
     */
    <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpectedSubgroup9<P1, P2, P3, P4, P5, P6, P7, P8, P9> xdescribes(String description,
            RunnableParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> specClosure);
}
