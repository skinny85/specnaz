...
public final class ParamsSpecBuilderCoreDslAdapter extends SpecBuilderCoreDslAdapter
    ...
    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8> ParamsExpected8<P1, P2, P3, P4, P5, P6, P7, P8> should(
    ...
    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8> ParamsExpected8<P1, P2, P3, P4, P5, P6, P7, P8> fshould(
            String description, TestClosureParams8<P1, P2, P3, P4, P5, P6, P7, P8> testBody) {
        return coreDslBuilder.focusedParametrizedTest8(shouldDescription(description), testBody);
    }

    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8> ParamsExpected8<P1, P2, P3, P4, P5, P6, P7, P8> xshould(
            String description, TestClosureParams8<P1, P2, P3, P4, P5, P6, P7, P8> testBody) {
        return coreDslBuilder.ignoredParametrizedTest8(shouldDescription(description), testBody);
    }

    @Override
    public <T extends Throwable, P1, P2, P3, P4, P5, P6, P7, P8> ParamsExpectedException8<T, P1, P2, P3, P4, P5, P6, P7, P8> shouldThrow(
            Class<T> expectedException, String description, TestClosureParams8<P1, P2, P3, P4, P5, P6, P7, P8> testBody) {
        return coreDslBuilder.parametrizedTestExpectingException8(expectedException,
                shouldThrowDescription(expectedException, description), testBody);
    }

    @Override
    public <T extends Throwable, P1, P2, P3, P4, P5, P6, P7, P8> ParamsExpectedException8<T, P1, P2, P3, P4, P5, P6, P7, P8> fshouldThrow(
            Class<T> expectedException, String description, TestClosureParams8<P1, P2, P3, P4, P5, P6, P7, P8> testBody) {
        return coreDslBuilder.focusedParametrizedTestExpectingException8(expectedException,
                shouldThrowDescription(expectedException, description), testBody);
    }

    @Override
    public <T extends Throwable, P1, P2, P3, P4, P5, P6, P7, P8> ParamsExpectedException8<T, P1, P2, P3, P4, P5, P6, P7, P8> xshouldThrow(
            Class<T> expectedException, String description, TestClosureParams8<P1, P2, P3, P4, P5, P6, P7, P8> testBody) {
        return coreDslBuilder.ignoredParametrizedTestExpectingException8(expectedException,
                shouldThrowDescription(expectedException, description), testBody);
    }

    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpected9<P1, P2, P3, P4, P5, P6, P7, P8, P9> should(
            String description, TestClosureParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> testBody) {
        return coreDslBuilder.parametrizedTest9(shouldDescription(description), testBody);
    }
    ...
    @Override
    public <T extends Throwable, P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpectedException9<T, P1, P2, P3, P4, P5, P6, P7, P8, P9> shouldThrow(
            Class<T> expectedException, String description, TestClosureParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> testBody) {
        return coreDslBuilder.parametrizedTestExpectingException9(expectedException,
                shouldThrowDescription(expectedException, description), testBody);
    }

    @Override
    public <T extends Throwable, P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpectedException9<T, P1, P2, P3, P4, P5, P6, P7, P8, P9> fshouldThrow(
            Class<T> expectedException, String description, TestClosureParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> testBody) {
        return coreDslBuilder.focusedParametrizedTestExpectingException9(expectedException,
                shouldThrowDescription(expectedException, description), testBody);
    }

    @Override
    public <T extends Throwable, P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpectedException9<T, P1, P2, P3, P4, P5, P6, P7, P8, P9> xshouldThrow(
            Class<T> expectedException, String description, TestClosureParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> testBody) {
        return coreDslBuilder.ignoredParametrizedTestExpectingException9(expectedException,
                shouldThrowDescription(expectedException, description), testBody);
    }
    ...
    @Override
    public <P1, P2, P3, P4, P5, P6, P7> ParamsExpectedSubgroup7<P1, P2, P3, P4, P5, P6, P7> describes(
    ...
    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpectedSubgroup9<P1, P2, P3, P4, P5, P6, P7, P8, P9> describes(
    ...
    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpectedSubgroup9<P1, P2, P3, P4, P5, P6, P7, P8, P9> fdescribes(
            String description, RunnableParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> specClosure) {
        return coreDslBuilder.focusedParametrizedSubSpecification9(description, specClosure);
    }

    @Override
    public <P1, P2, P3, P4, P5, P6, P7, P8, P9> ParamsExpectedSubgroup9<P1, P2, P3, P4, P5, P6, P7, P8, P9> xdescribes(
            String description, RunnableParams9<P1, P2, P3, P4, P5, P6, P7, P8, P9> specClosure) {
        return coreDslBuilder.ignoredParametrizedSubSpecification9(description, specClosure);
    }
}
