...
public final class ParametrizedExceptionTest4<T extends Throwable, P1, P2, P3, P4> extends
        AbstractParametrizedExceptionTest<T> {
    private final TestClosureParams4<P1, P2, P3, P4> testBody;

    public ParametrizedExceptionTest4(ThrowableExpectations<T> throwableExpectations, String description,
