...
/**
 * The API for using JUnit 4 instance (as opposed to class) Rules in Specnaz.
 * You use it by declaring a {@code public} field of this type in your spec class.
 * It will be picked up by the Specnaz JUnit 4 Runner,
 ...
 * by the Specnaz JUnit 4 Runner before every test,
 ...
 * </code></pre>
 *
 * <b>Note</b>: 'vanilla' JUnit 4 allows you to specify instance Rules by annotating methods
...
public abstract class Rule<T> {
    ...
    /**
     * The wrapper class used in the Specnaz JUnit 4 Runner.
